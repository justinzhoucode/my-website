// Inline SVG icons (no icon library) for the persistent links row.
  ...
  return (
    <div className="mt-4 flex items-center gap-4 text-muted">
      <a
        ...
        rel="noreferrer"
        aria-label="GitHub"
        className="inline-flex transition duration-150 hover:scale-125 hover:text-fg"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <a
        ...
        aria-label="Email"
        className="inline-flex transition duration-150 hover:scale-115 hover:text-fg"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
